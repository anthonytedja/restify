...
const MenuItemPage = () => {
  ...
  useEffect(() => {
    fetch(
      `https://anthonytedja.pythonanywhere.com/restaurants/${restaurantID}/menu/${menuID}`
    )
      .then((res) => {
        if (res.status >= 400) {
  ...
  const deleteitem = (e) => {
    ...
    fetch(
      `https://anthonytedja.pythonanywhere.com/restaurants/${restaurantID}/menu/${menuID}/delete/`,
      {
        method: "DELETE",
        headers: {
                ...
                <div
                  ...
                  style={{
                    backgroundImage: avatar
                      ? `url(https://anthonytedja.pythonanywhere.com/media/${avatar})`
                      : `url(${defaultLogo})`,
                  }}
                />
                <p>
