...
const RestaurantPage = () => {
  ...
  const editvisibility = !sessionStorage.getItem("token")
    ? "hidden"
  ...
  useEffect(() => {
    ...
    fetch(
      `https://anthonytedja.pythonanywhere.com/restaurants/${restaurantID}/follow/`,
      {
        headers: {
  ...
  const handleLike = (e) => {
    ...
    fetch(
      `https://anthonytedja.pythonanywhere.com/restaurants/${restaurantID}/likes/`,
      {
        method: "POST",
        headers: {
          Authorization: sessionStorage.getItem("token"),
        ...
        <section>
          <div className="mx-auto header-content">
            ...
            <section className="form-section" style={{ padding: 20 }}>
              <div
                className="mx-auto"
                style={{ maxWidth: 1000, display: "block" }}
              >
                <div className="profile-card">
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${
                        header
                          ? "https://anthonytedja.pythonanywhere.com/media/" +
                            header
                  ...
                  <button
                    className="btn btn-primary restaurant-button"
                    type="submit"
                    style={{ backgroundColor: followBtnColor }}
                    onClick={handleFollow}
                  >
                    {followers}&nbsp;
                    <i className={followBtnIcon} />
                  </button>
                  <Link
                    className="btn btn-primary restaurant-button"
                    style={{
