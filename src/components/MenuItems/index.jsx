...
const MenuItems = () => {
    ...
    useEffect(() => {
        fetch(`https://anthonytedja.pythonanywhere.com/restaurants/${restaurantID}/menu/all/`)
            .then(res => {
                if (res.status >= 400) {
    ...
    const handleDelete = (event) => {
        ...
        fetch(`https://anthonytedja.pythonanywhere.com/restaurants/${restaurantID}/menu/${itemID}/delete/`, {
            method: "DELETE",
            headers: {
            ...
            .then(res => {
                ...
                let newResult = result.results.filter(item => String(item.id) !== String(itemID));
