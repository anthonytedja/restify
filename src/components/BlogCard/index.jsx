...
const BlogCard = ({ title, body, date, restaurant, id }) => {
    ...
    return (
        <li className="blog-card">
            <Link className="page-link-p1" to={`/restaurants/${restaurant}/blogs/${id}`}>
                <div className="blog-card-body">
                    ...
                    <div className="blog-card-author-container">
                        ...
                        <Link to={`/restaurants/${restaurant}`}><button className="btn btn-primary" style={{ backgroundColor: "lightcoral", position: "absolute", right: "1vh", bottom: "1vh" }}>{restaurantName}&nbsp;</button></Link>
                    </div>
                </div>
            </Link>
        </li>
